...
function Header(props: any) {
  ...
  const ConnectMetaMask = async () => {
    if ((window as any).ethereum) {
      const MetaMaskAccount = await (window as any).ethereum
  ...
  const connectPopup = (
    <div id="wallet-list" className="ant-connect-form">
      <h1 className="cf-title">use account from</h1>
  ...
  const settingPopup = (
    <div id="setting-id" className="setting-popup-wrapper">
      <h1 className="cf-title">global references</h1>
  ...
  const bellPopup = (
    <div id="bell-id" className="setting-popup-wrapper">
      <h1 className="cf-title">activity</h1>
      <div className="bell-wrapper">
        <NoNotification />
        <div className="bell-text">No activity yet!</div>
      </div>
    </div>
  );
