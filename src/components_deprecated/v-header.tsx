...
function VHeader(props : any) {
    ...
    const MyQuestion = props.Question
    const MySetQuestion = props.SetQuestion
    const PollID = props.MyPollID
    const SetPollID = props.SetMyPollID
    const setMyNumberOfQuestion = props.setNumberOfVoter
    ...
    const NewPoll = props.CreatePool
    ...
    function openVoteModal(e: any) {
        e.stopPropagation()
        const id = (document.getElementById("vote-modal")) as HTMLSelectElement
